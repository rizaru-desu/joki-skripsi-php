...
<div class="page-content p-5" id="content">
    ...
    <h1>Form Penyimpanan Barang</h1>

    <form action="/addPenyimpanan" method="post">
        ...
        <div class="form-group">
            <label>stock_barang</label>
            <input class="form-control" type="number" name="stock_barang" placeholder="Enter Stock Barang">
        </div>
        ...
        <div class="form-group">
            <label>Fraktur</label>
            <input class="form-control" name="faktur" placeholder="Enter Faktur">
        </div>
