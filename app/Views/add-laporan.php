    ...
    <ul class="nav flex-column bg-light mb-0">
        <li class="nav-item">
            <a href="#" class="nav-link text-dark bg-light">
                <i class="fa fa-th-large mr-3 text-light fa-fw"></i>
                Dashboard
            </a>
        </li>
        <li class="nav-item">
...
<div class="page-content p-5" id="content">
    ...
    <form action="/addLaporan" method="post">
        ...
        <div class="form-group">
            ...
            <input class="form-control" type="number" name="jml_barang" placeholder="Enter Stock Barang">
        </div>
        ...
        <div class="form-group">
            ...
            <input class="form-control" id="number" name="harga_barang">
        </div>
